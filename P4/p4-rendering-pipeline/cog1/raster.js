...
define(["exports", "shader", "framebuffer", "data", "glMatrix"], function ( //
  ...
  function assembleIntersectionForScanline(
    ...
    // >This is irrelevant at the moment. In the current implementation I do not check for valid triangles and
    // >only care for lines, since every line can have a derivative. TODO
    if (!lastDerivative) {
      return;
    }

 ...
 */
 define(["exports", "dojo/dom-construct"], function(exports, domConstruct) {
    ...
    function sample(uvVec, color) {
        ...
        color.rgbaShaded[0] = textureRGBA[index];
        color.rgbaShaded[1] = textureRGBA[index + 1];
        color.rgbaShaded[2] = textureRGBA[index + 2];
        color.rgbaShaded[3] = textureRGBA[index + 3];
